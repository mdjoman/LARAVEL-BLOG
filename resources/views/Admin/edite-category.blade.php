...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="{{ route('delete-category', [ 'id' => $category->id])}}" class="d-none d-sm-inline-block btn btn-sm shadow-sm btn-danger"><i class="fas fa-download fa-sm text-white-50"></i> Delete Category</a>
  </div>
</div>
...
<div class="card card-body mb-5">
  <div class="container">
    ...
    <div class="container" style="margin-bottom: 10rem;">
      <form class="" action="{{ route ('update-category')}}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="file" style="background-color: #fff; vertical-align: top !important;" class="" id="Categories Name" placeholder="Category image" name="image">
            <span><img src="{{ asset($category->image)}}" width="200px" height="150px" alt=""></span>
          </div>
